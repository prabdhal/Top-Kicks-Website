...
- Created 4 html pages using ejs as the view engine (home, login, registration and 404 page)

- Used @hapi/joi library to create a template for registeration, subscription and login validation
